...
<?php echo $this->Form->create('MgsComment');?>
	<fieldset>
		<legend><?php __('Edit Mgs Comment'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $this->Form->value('MgsComment.id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $this->Form->value('MgsComment.id'))); ?></li>
