...
<?php echo $this->Form->create('MgsGirlMaster');?>
	<fieldset>
		<legend><?php __('Edit Mgs Girl Master'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $this->Form->value('MgsGirlMaster.id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $this->Form->value('MgsGirlMaster.id'))); ?></li>
