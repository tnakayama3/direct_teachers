...
<?php echo $this->Form->create('MgsUser');?>
	<fieldset>
		<legend><?php __('Edit Mgs User'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $this->Form->value('MgsUser.id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $this->Form->value('MgsUser.id'))); ?></li>
