...
<?php echo $this->Form->create('MgsRealcoin');?>
	<fieldset>
		<legend><?php __('Edit Mgs Realcoin'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $this->Form->value('MgsRealcoin.id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $this->Form->value('MgsRealcoin.id'))); ?></li>
